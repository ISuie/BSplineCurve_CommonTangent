function [quadRef,estErrorGlob]=recoverDerivEstGalMP2alphaAll(PHTelem, GIFTmesh, sol0, target_rel_error, quadList, p, q, Cmat, targetScale)
...
quadRef = cell(1, numPatches); %flag which patches to be refined
