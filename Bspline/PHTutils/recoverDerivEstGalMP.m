function [patchRef,estErrorGlob]=recoverDerivEstGalMP(PHTelem, GIFTmesh, sol0, target_rel_error, patchList, p, q, Cmat)
...
local_target = 10/size(patchList,1)*target_rel_error^2*h1norm_glob;
for j=1:size(patchList,1)
    % j
    % patchList(j,:)
