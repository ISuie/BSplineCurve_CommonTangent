function  plotSolPHTElasticMPVM( sol0, PHTelem, GIFTmesh, p, q, Cmat, factor )
...
figure
trisurf(element4,physcoord(:,1)+dispcoord(:,1)*factor, physcoord(:,2)+dispcoord(:,2)*factor, zeros(size(physcoord,1),1), sigmacoord, 'EdgeColor','none','facecolor','interp')
view(0,90)
