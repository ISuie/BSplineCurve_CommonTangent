function [v1, no_itr, norm1, psqt] = Newton_rational_modified2_vari(cA, p0, ss0, ss1, sv, cB, p1, tt0, tt1, tv, no_itr, error, vari)
...
while true
    % compute jacobian
    [fnv1, jacob_fnv1] = evalf1f2_rational_modified2_vari(cA, p0, ss0, ss1, v1(1), cB, p1, tt0, tt1, v1(2), vari);
    %jacob_fnv1 = feval(jacob_fn,v1);
    
    % avoid the ill-conditioned Jacobian
    %if(norm(fnv1)<=0.0000001 || cond(jacob_fnv1)>100000000.0)
    if( cond(jacob_fnv1)>10000000000.0)
        break;
    end
    H = jacob_fnv1\fnv1;
    v1 = v1 - H;
    ...
    fnv1 = evalf1f2_rational_modified2_vari(cA, p0, ss0, ss1, v1(1), cB, p1, tt0, tt1, v1(2),vari); 
    % fnv1 = feval(fn,v1);
    i = i + 1 ;
    norm1 = norm(fnv1);
